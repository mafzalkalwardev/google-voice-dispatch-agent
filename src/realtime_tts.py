    ...
    def speak(self, text: str, interrupt: bool = True) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error("RealtimeTTS: playback failed for '%s': %s", text[:80], exc)
            finally:
    ...
    def speak_async(self, text: str, interrupt: bool = True) -> threading.Thread:
        ...
        def _worker() -> None:
            try:
                ...
                logger.error("RealtimeTTS: async speak failed for '%s': %s", text[:80], exc)
        ...
        if self._cache is not None:
            ...
            if cached_bytes:
                ...
                try:
                    ...
                    _play_numpy_to_device(data, rate, self.device_index, self._stop_requested)
                    return
                except Exception as exc:
